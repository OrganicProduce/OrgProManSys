...
public class Vegetables extends AppCompatActivity {
                ...
                if (firebaseAuth.getCurrentUser() != null) {
                    ...
                    add.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent i = new Intent(Vegetables.this, Admin.class);
                            i.putExtra("keyroot","Vegetables");
                            startActivity(i);
                        }
                    });
                }
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<gtr, BlogViewholder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<gtr, BlogViewholder>(gtr.class,R.layout.designh,BlogViewholder.class,mdatabase) {
            @Override
            protected void populateViewHolder(BlogViewholder viewHolder, gtr model, int position) {
               ...
               viewHolder.setHomeaddress(model.getHomeaddress());
                ...
                viewHolder.view.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(Vegetables.this, "Loading details...", Toast.LENGTH_LONG).show();
                        mdatabase.child(pskey).addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                Intent intent = new Intent(Vegetables.this, Main2Activity.class);
                                intent.putExtra("message", pskey);
                                intent.putExtra("keyroot","Vegetables");
