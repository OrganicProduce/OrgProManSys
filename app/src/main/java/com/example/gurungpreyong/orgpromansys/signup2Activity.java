...
public class signup2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnResetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            startActivity(new Intent(signup2Activity.this, chagepasswordActivity.class));
            }
        });
                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(signup2Activity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(signup2Activity.this, "Register successfully :" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
